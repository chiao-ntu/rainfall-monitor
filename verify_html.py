...
MUST = ['getAccum', 'setWin', 'onSlider', '_spanAccum', '_hourlyBars', '_futuHourly',
        ...
        '_lookaheadEtr', '_lookaheadAlerts', '_lookaheadHtml', '_lookaheadAlertHtml',
        '_segAfterHours', '_etrPctAfter', '_etr2NowRow', '_etr2NowLabel', '_safeCall', '_etr2HourlySeries', '_calcDistrictDaily',
        '_calcDistrictHyeto',
